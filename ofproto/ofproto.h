...
enum ofproto_table_config {
    OFPROTO_TABLE_MISS_CONTROLLER = OFPTC_TABLE_MISS_CONTROLLER,
                                        /* Send to controller. */
    OFPROTO_TABLE_MISS_CONTINUE   = OFPTC_TABLE_MISS_CONTINUE,
                                        /* Continue to the next table in the
                                           pipeline (OpenFlow 1.0 behavior). */
    OFPROTO_TABLE_MISS_DROP       = OFPTC_TABLE_MISS_DROP,
                                        /* Drop the packet. */
